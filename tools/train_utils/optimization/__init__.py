...
def build_scheduler(optimizer, total_iters_each_epoch, total_epochs, last_epoch, optim_cfg):
    ...
    if optim_cfg.OPTIMIZER == 'adam_onecycle':
        ...
        # lr_scheduler = lr_sched.LambdaLR(optimizer, lr_lambda=swin_lr, last_epoch=last_epoch)
        lr_scheduler = lr_sched.MultiStepLR(optimizer, milestones=optim_cfg.DECAY_STEP_LIST, last_epoch=last_epoch)
    else:

...
class PVTNet(nn.Module):
    ...
    def build_swin(self, cfg, in_channels):
        self.pvt_backbone = PyramidVisionTransformer(img_size=cfg.FEATURE_SIZE, patch_size=cfg.PATCH_SIZE,
                                        in_chans=in_channels, embed_dims=cfg.EMBED_DIM, 
                                        num_heads=cfg.NUM_HEADS, depths=cfg.DEPTHS,
                                        reshape_back=cfg.RESHAPE)

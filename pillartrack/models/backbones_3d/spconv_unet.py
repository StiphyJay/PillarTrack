...
class UNetV2(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        template_point_feature, template_point_coords = self.forward_feature(batch_size, template_voxel_features, template_voxel_coords)
        search_point_feature, search_point_coords = self.forward_feature(batch_size, search_voxel_features, search_voxel_coords)
    ...
    def forward_feature(self, batch_size, voxel_features, voxel_coords):
        """
        Args:
            batch_dict:
                batch_size: int
